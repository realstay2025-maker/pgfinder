...
const { getAllUsers, deleteUser, getAdminStats, getSubscriptions, updateSubscriptionStatus, getSubscriptionHistory, toggleListing, getSystemAnalytics } = require('../controllers/admincontroller');
...
router.get('/analytics', adminProtect, getSystemAnalytics);
